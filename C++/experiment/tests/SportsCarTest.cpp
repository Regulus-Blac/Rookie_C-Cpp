...
//  11.FR
    TEST_F(SportsCarTest,should_return_x_plus_l_y_minus_1_and_facing_S_given_command_is_FR_and_facing_is_E) {
            //  given
            //  when
            executor->Execute("FR");
            //  then
...
//  12.FBR
    TEST_F(SportsCarTest, should_return_x_minus_l_y_minus_1_and_facing_N_given_command_is_FBR_and_facing_is_E){
            //  given
            //  when
